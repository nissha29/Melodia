...
function FeaturesSection() {
  return (
    <div className='relative bg-secondary-bg rounded-[5rem] md:h-96 sm:h-[65rem] md:mt-24 sm:mt-40 2xl:mx-2xl-screen xl:mx-xl-screen lg:mx-lg-screen md:mx-md-screen sm:mx-sm-screen'>
        <div className='flex justify-center items-center md:gap-14 sm:gap-10 font-playwrite xl:px-20 py-12 lg:px-11 md:px-8 md:flex-row sm:flex-col'>
            <div className='absolute xl:top-[-16rem] lg:left-[-4rem] lg:top-[-14.5rem] md:top-[-11rem] md:left-[-2.5rem] sm:top-[-9.3rem] sm:left-[-3.3rem]'>
                <img src={man} alt="man" className='xl:w-80 lg:w-72 md:w-56 sm:w-56'/>
            </div>
            <div className='absolute xl:top-[-23rem] right-[-8rem] lg:top-[-19rem] lg:right-[-5.5rem] md:top-[-15rem] md:right-[-1.5rem] sm:bottom-[-8rem] sm:right-[-6rem]'>
                <img src={woman} alt="woman" className='xl:w-96 lg:w-80 md:w-64 sm:w-60'/>
            </div>
            <div className='bg-white rounded-[2rem] md:w-[25rem] sm:w-[21rem] h-72 flex flex-col items-center gap-2'>
                <div>
