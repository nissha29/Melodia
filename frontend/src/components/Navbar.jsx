...
function Navbar() {
  ...
  return (
    <div className={`relative rounded-lg h-20 2xl:mx-2xl-screen xl:mx-xl-screen lg:mx-lg-screen md:mx-md-screen sm:mx-sm-screen mx-5 ${isDarkMode ? 'bg-green-800' : 'bg-white'}`}>
