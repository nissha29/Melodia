...
import { myTracksState } from '../store/atoms/myTracksState.js';
import { useFetchMyTracks } from '../hooks/useFetchMyTracks.js';
...
export default function MyTracks() {
    ...
    const { fetchMyTracks } = useFetchMyTracks();
        ...
        <div className="bg-primary-bg text-white sm:px-7 px-3 overflow-y-scroll scrollbar-none">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 mb-8">
                ...
                <div>
                    ...
                    <h1 className="xl:text-9xl lg:text-8xl md:text-7xl sm:text-[3.6rem] text-4xl font-bold mb-4">My Tracks</h1>
                </div>
            </div>
